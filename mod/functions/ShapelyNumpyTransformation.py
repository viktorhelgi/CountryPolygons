"""
Module: ShapelyNumpyTransformation.py
Old Name: Polygons_Arrays_transformation.py
...
-----------------------------------
Note:
This function has been tested quite drastically so probably works as expected.
However, it is recommended to raise an exception after calling it if it returns
the wrong type.
It probably needs some extra work. But looks like it works quite well.
-----------------------------------
"""
#------------------------------------------------------------------------------
import typing as tp
...
def __test_Polygon_to_Array__(testing = True):
...
def __test_Linestring_to_Array__(testing = True):
...
def __test_MultiPolygon_to_List_of_numpy__(testing = True):
...
def __test_LineString_to_List_of_numpy__(testing = True):
    # test
...
def __numpy_to_poly__(testing = True):
    # test
...
def __numpy_to_line__(testing = True):
    # test
    numpy_arr = np.array([(1,2),(3,4),(5,6),(3,2),(1,2)])
...
def __list_numpy_to_multipolygon__(testing = True):
    # test
...
def __list_numpy_to_multilinestring__(testing = True):
    # test
    numpy_arr_a = np.array([(1,2),(3,4),(5,6),(3,2),(1,2)])
    numpy_arr_b = np.array([(0,4),(1,3),(19,1),(2,3),(9,1),(4,1),(0,4)])
    list_numpy = [numpy_arr_a, numpy_arr_b]
...
def __list_of_lists_of_tuples_TO_list_of_polygons__(testing = True):
...
def __tests_initializer__(test_id, testing = True):
    if test_id == 1:
        print('\nTest Polygon_to_Array')
        __test_Polygon_to_Array__(testing = testing)
        print('Worked\n###########################################')
    elif test_id == 2:
        print('\nTest Polygon_to_Array')
        __test_Linestring_to_Array__(testing = testing)
        print('Worked\n###########################################')
    elif test_id == 3:
        print('\nTest test_MultiPolygon_to_List_of_numpy')
        __test_MultiPolygon_to_List_of_numpy__(testing = testing)
        print('Worked\n###########################################')
    elif test_id == 4:
        print('\nTest test_MultiPolygon_to_List_of_numpy')
        __test_LineString_to_List_of_numpy__(testing = testing)
        print('Worked\n###########################################')
    elif test_id == 5:
        print('\nTest numpy_to_poly')
        __numpy_to_poly__(testing = testing)
        print('Worked\n###########################################')

    elif test_id == 6:
        print('\nTest numpy_to_line')
        __numpy_to_line__(testing = testing)
        print('Worked\n###########################################')

    elif test_id == 7:
        print('\nTest list_numpy_to_multipolygon')
        __list_numpy_to_multipolygon__(testing = testing)
        print('Worked\n###########################################')

    elif test_id == 8:
        print('\nTest list_numpy_to_multilinestring')
        __list_numpy_to_multilinestring__(testing = testing)
        print('Worked\n###########################################')
    elif test_id == 9:
        print('\nTest list_of_lists_of_tuples_TO_list_of_polygons')
        __list_of_lists_of_tuples_TO_list_of_polygons__(testing = testing)
        print('Worked\n###########################################')


def __call_tests__(testing = False):
    test_ids = [1,2,3,4,5,6,7,8]
    for id in test_ids:
        print('\n###########################################')
        __tests_initializer__(test_id = id, testing = testing)


if __name__ == '__main__':
    __call_tests__(testing = True)
